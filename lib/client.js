...
function Loaded(props) {
  ...
  const changed = status === void 0 || draft.enabled !== status.settings.enabled || draft.managerBaseUrl !== status.settings.managerBaseUrl || draft.roleId !== status.settings.roleId;
